...
function NuevoCliente() {
  ...
  return (
    <>
       ...
       <p className='mt-3'>Llena todos los campos para registrar nuevos clientes</p>
      ...
      <div className="bg-white shadow rounded-md md:w-3/4 mx-auto px-5 py-10 mt-20">
        ...
        >
          ...
          <input type="submit" className="mt-5 w-full bg-blue-800 uppercase font-bold text-white text-lg" value='Registar Cliente'/>
        </Form>
      </div>
    </>
  )
